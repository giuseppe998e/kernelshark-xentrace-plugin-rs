...
fn get_trc_gen_info_str(event: &Event) -> String {
    todo!()
}

fn get_trc_sched_info_str(event: &Event) -> String {
    todo!()
}

fn get_trc_dom0op_info_str(event: &Event) -> String {
    todo!()
}

fn get_trc_hvm_info_str(event: &Event) -> String {
    todo!()
}

fn get_trc_mem_info_str(event: &Event) -> String {
    todo!()
}

fn get_trc_pv_info_str(event: &Event) -> String {
    todo!()
}

fn get_trc_shadow_info_str(event: &Event) -> String {
    todo!()
}

fn get_trc_hw_info_str(event: &Event) -> String {
    todo!()
}

fn get_trc_guest_info_str(event: &Event) -> String {
    todo!()
}
